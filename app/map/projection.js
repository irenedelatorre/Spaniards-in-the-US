  ...
  geoAlbersUsaPr: function () {
    ...
    albersUsa.translate = function (_) {
      ...
      alaskaPoint = alaska
        ...
        .clipExtent([
          [
            x - 0.425 * k + projection.epsilon,
            y + 0.12 * k + projection.epsilon,
          ],
          [
            x - 0.214 * k - projection.epsilon,
            y + 0.234 * k - projection.epsilon,
          ],
        ])
        .stream(pointStream);
      ...
      hawaiiPoint = hawaii
        ...
        .clipExtent([
          [
            x - 0.214 * k + projection.epsilon,
            y + 0.166 * k + projection.epsilon,
          ],
          [
            x - 0.115 * k - projection.epsilon,
            y + 0.234 * k - projection.epsilon,
          ],
        ])
        .stream(pointStream);
